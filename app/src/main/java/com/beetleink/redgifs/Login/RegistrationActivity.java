...
package com.beetleink.redgifs.Login;
...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RegistrationActivity.this, com.example.chmarax.logregform.LoginActivity.class));
            }
        });
    ...
    private void sendUserData(String username, String password){
        ...
        com.example.chmarax.logregform.UserProfile user = new com.example.chmarax.logregform.UserProfile(username, password);
