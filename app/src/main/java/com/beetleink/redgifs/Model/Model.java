...
public class Model {
    ...
    public Model(String title, String description, String data, String user_id, String post_categories, String post_id, String view, String user_name, String media_url, String thumbnail) {
        this.title = title;
